...
const YOUTUBE_DL_HOST =
  get("YOUTUBE_DLP_HOST") ||
  "https://api.github.com/repos/yt-dlp/yt-dlp/releases?per_page=1";

const YOUTUBE_DL_DIR =
  get("YOUTUBE_DLP_DIR") || path.join(__dirname, "..", "bin");

const YOUTUBE_DL_PLATFORM =
  get("YOUTUBE_DLP_PLATFORM") || isUnix(process.platform)
    ? PLATFORM_UNIX
    : PLATFORM_WIN;

const YOUTUBE_DL_FILENAME = get("YOUTUBE_DLP_FILENAME") || "yt-dlp";
...
const YOUTUBE_DL_SKIP_DOWNLOAD = get("YOUTUBE_DLP_SKIP_DOWNLOAD");
